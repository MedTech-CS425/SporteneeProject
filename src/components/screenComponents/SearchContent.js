  ...
  const searchData = [
    {
      id: 0,
      images: [
        require('../../storage/images/Biva.jpg'),
        require('../../storage/images/Blank.png'),
        require('../../storage/images/chelsea.jpg'),
        require('../../storage/images/Club-Africain.jpg'),
        require('../../storage/images/Malek-Jaziri.jpg'),
        require('../../storage/images/Nat.jpg'),
      ],
    },
    {
      id: 1,
